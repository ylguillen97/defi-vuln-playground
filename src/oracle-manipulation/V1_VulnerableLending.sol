...
/// @title V1_VulnerableLending
/// @notice Vulnerable: uses AMM spot price as oracle for collateral valuation.
contract V1_VulnerableLending {
    ERC20Mock public immutable COL;
    ERC20Mock public immutable DEBT;
    ISpotOracle public immutable ORACLE;

    // Loan-to-Value, 1e18 scaled (e.g. 0.5e18 = 50%)
    ...
    function maxBorrowable(address user) public view returns (uint256) {
        uint256 price = ORACLE.spotPriceDebtPerCol(); // manipulable spot
